...
namespace Another_World_Adventure
{
    public static class Weapons
    {
        ...
        public static BaseWeapon ApollosBow = new BaseWeapon("Apollo'Bow", "Golden and blinding to the noraml eye, it was made for one with the Sun.", 6, BaseWeapon.WeaponTypes.Bow, 2);
