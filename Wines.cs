...
namespace Another_World_Adventure
{
    public static class Wines
    {
        ...
        public static BaseWine Liatiko = new BaseWine("Liatiko", "Delicately spicy, rick red-berry falvored with soft tannins and moderate acidity wine.", 10, 20, BaseWine.WineTypes.SourWine, 3);
